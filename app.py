...
def main():
    ...
    if st.session_state.authenticated:
        ...
        1. **Add your app content** in this file (`app.py`)
        2. **Create additional pages** by adding files to `pages/` directory
        3. **Customize the footer** in `config/app_config.py`
        4. **Add database tables** in `scripts/init_db.py`
